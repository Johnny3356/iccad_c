...
puts "Global routing…"
global_route
# 用全局路由后的 parasitic 做详细路由
estimate_parasitics -global_routing
puts "Detail routing…"
detailed_route

# ────── 5) 电源网 & 去耦插入（可选） ──────
puts "Generating PDN & inserting decaps…"
pdn_generation -stripe_width 0.5
insert_decap   -net VDD -target_cap 0.2    ;# 0.2pF 去耦

# ────── 6) 最后一轮 parasitic & 报告 ──────
puts "Final parasitic estimate…"
estimate_parasitics -placement
